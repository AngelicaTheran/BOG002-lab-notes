    ...
    return (
        <div className="task__entry pointer">
            ...
            style={{
                ...
                backgroundImage: "url(https://heroineproblem.files.wordpress.com/2015/10/four-horsemen-of-patriarchy-revolution-girl-utena-01.png)"                
            }}
            >
            </div>
